        ...
        <main>
            ...
            <section className="about-content"> 
                <div className="about-center">
                    ...
                    <p className="storyStartEnd manrope-medium">The Fresh Future Foundation was created by Ethan Chan and Saketh Bongu. They were just a couple of sophomores in high school, however, these kids saw true problems in the world, problems they felt compelled to fix.</p>
